...
- 현재 버전: 0.11, 현재 키보드 실측에 맞춘 Command·Control 출력 교환
...
- 0.11: CapsLock·Alt의 Windows 출력 교환, 원격 Mac 역할은 실기 재확인 필요
...
3. `Kaymap 0.11 — Parsec 매핑 ON` 창 확인
...
- 실제 Windows Hook·Parsec·Mac 앱을 통한 0.11의 Alt+W 동작은 실기 확인 필요
